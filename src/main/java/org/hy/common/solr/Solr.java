...
public class Solr
{
    ...
    public synchronized SolrClient getSolr()
    {
        ...
        {
            Builder v_SolrBuilder = new HttpSolrClient.Builder(this.baseURL);
            
            this.solrServer = v_SolrBuilder.build();
    ...
    public void addObj(List<Object> i_Datas)
    {
        ...
        SolrClient v_Server = this.getSolr();
    ...
    private <T> List<T> toBean(SolrDocumentList i_SolrDocs ,Class<T> i_BeanClass)
    {
        ...
        v_Beans = this.getSolr().getBinder().getBeans(i_BeanClass ,i_SolrDocs);
